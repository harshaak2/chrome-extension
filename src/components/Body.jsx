...
export default function Body() {
  ...
  const processWithAI = async (text) => {
    ...
    try {
      ...
      const mockResponse = {
        message: "I can help analyze your dataset. Here are some options:",
        agents: [
          { id: 1, name: "Data Analysis Agent", description: "Perform basic statistical analysis on your data" },
          { id: 2, name: "Visualization Agent", description: "Create charts and graphs from your data" },
          { id: 3, name: "Machine Learning Agent", description: "Run predictive models on your dataset" }
        ]
      };
  ...
  return (
      <div className="flex flex-col h-full max-h-[500px] bg-gray-50 rounded-lg shadow-md">
          ...
          {/* Input section with collapsible context input */}
